...
| Expected tool path | 1.00 | — |
| Recites the right step (baseline only) | — | 0.31 |
| Distinct tool paths (proof of agency) | 7 | 1 |

## Tool-path divergence (agent)

- `(none)` — ambiguous_dj_tripped
- `diff_completed_steps` — config_not_asked_when_no_branch_needs_it, panto_missed_bp_check, qlm_clean_confirm, qlm_missed_arc_chutes_10_2, qlm_missed_oil_level
